<template>
  <create-form @onSubmit="submit">
    <div class="row align-items-center">
      ...
      />
      <!------------ Single Input ------------>
      <v-select-container title="Menu Type">
        <v-select
          v-model="data.menu_types"
          label="name"
          :reduce="(obj) => obj.id"
          :options="menu_types"
          placeholder="--Select One--"
      ...
      <!------------ Single Input ------------>
      <v-select-container title="Menu Look Type">
        <v-select
      ...
      />
      <!------------ Single Input ------------>
      <v-select-container title="Menu Position">
        <v-select
...
export default {
  ...
  validators: {
    ...
    "data.menu_types": function (value = null) {
